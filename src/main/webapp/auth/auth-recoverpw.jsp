        ...
        <div class="card mb-0 shadow-none">
            <div class="card-body">
                    ...
                    <form class="form-horizontal my-4" action="index.html">
                        ...
                        <div class="form-group mb-0 row">
                            <div class="col-12 mt-2">
                                <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Reset <i class="fa fa-sign-in ml-1"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="m-3 text-center p-3 text-primary">
                    ...
                    <p class="font-13">Sign In <span>Amezia</span> Now</p>
                    <a href="#" class="btn btn-secondary waves-effect waves-light">Sign In Here</a>
                </div>
