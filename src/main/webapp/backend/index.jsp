                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="activity">
                                ...
                                <img src="assets/images/users/user-1.jpg" alt="" class="img-activity">
                                <div class="time-item">
                                    <div class="item-info">
                                        <div class="text-muted text-right font-10">5 minutes ago</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="progress mt-2 mb-4 bg-dark" style="height:6px;">
                                    ...
                                    <div class="progress mt-2 bg-dark" style="height:6px;">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="input-group custom-input">
                                ...
                                <button class="btn btn-danger add-new-todo-btn">Add</button>
                            </div>
                        </div>
                    </div>
                </div>
